...
contract BitDAO is ERC20 {
  ...
  function delegateBySig(
    ...
    require(
      signatory != address(0),
      'BitDAO::delegateBySig: invalid signature'
    );
    require(
      nonce == nonces[signatory]++,
      'BitDAO::delegateBySig: invalid nonce'
    );
    require(
      block.timestamp <= expiry,
      'BitDAO::delegateBySig: signature expired'
    );
    ...
    returns (uint256)
  {
    require(
      ...
      'BitDAO::getPriorVotes: not yet determined'
    );
  ...
  function _writeCheckpoint(
    ...
    uint256 blockNumber = safe32(
      block.number,
      'BitDAO::_writeCheckpoint: block number exceeds 32 bits'
    );
